...
(cl:defmethod cl:initialize-instance :after ((m <WaypointPath>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointPath)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name zeno_mission-msg:<WaypointPath> is deprecated: use zeno_mission-msg:WaypointPath instead.")))

(cl:ensure-generic-function 'waypoints-val :lambda-list '(m))
(cl:defmethod waypoints-val ((m <WaypointPath>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader zeno_mission-msg:waypoints-val is deprecated.  Use zeno_mission-msg:waypoints instead.")
  (waypoints m))
