...
class LatitudeLongitudeDepth {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LatitudeLongitudeDepth(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new LatitudeLongitudeDepth(null);
...
module.exports = LatitudeLongitudeDepth;
