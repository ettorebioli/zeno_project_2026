...
void teleoperation_request_callback(const std_msgs::Bool::ConstPtr& msg)
{
    teleop_active = msg->data;
}
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber teleoperation        = node_obj.subscribe("/joystick/teleoperation", 1, teleoperation_request_callback);
