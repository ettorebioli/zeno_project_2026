...
class GeolocalizationNode:
	...
	print("Initialization\n")
        ...
        # cartella per salvare i report testuali finali degli oggetti geolocalizzati
        self.list_text_folder = rospy.get_param('~list_text_folder', "/home/student/catkin_ws/results/9_list_texts")
...
# ________________________________________________________________________________________________________________________________
    ...
    def geolocalize_detection(self, msg, object_index, image_width):
        ...
        object_latitude, object_longitude = self.ne2ll(
