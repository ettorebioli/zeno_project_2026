...
class ListCreatorNode:
	...
	print("Initialization\n")
        ...
        # creare cartella per immagini filtrate
        self.filtered_image_folder = "/home/student/catkin_ws/results/2_filtered_images"
        if not os.path.exists(self.filtered_image_folder):
            os.makedirs(self.filtered_image_folder)

        # creare cartella per immagini saliency map
        self.saliency_image_folder = "/home/student/catkin_ws/results/3_saliency_images"
        if not os.path.exists(self.saliency_image_folder):
            os.makedirs(self.saliency_image_folder)

        # creare cartella per immagini saliency binary map
        self.saliency_binary_image_folder = "/home/student/catkin_ws/results/4_saliency_binary_images"
        if not os.path.exists(self.saliency_binary_image_folder):
            os.makedirs(self.saliency_binary_image_folder)

        # creare cartella per immagini binary maps
        self.binary_maps_image_folder = "/home/student/catkin_ws/results/5_binary_maps_images"
        if not os.path.exists(self.binary_maps_image_folder):
            os.makedirs(self.binary_maps_image_folder)

        self.bright_map_folder = "/home/student/catkin_ws/results/5_binary_maps_images/bright_maps"
        if not os.path.exists(self.bright_map_folder):
            os.makedirs(self.bright_map_folder)

        self.dark_map_folder = "/home/student/catkin_ws/results/5_binary_maps_images/dark_maps"
        if not os.path.exists(self.dark_map_folder):
            os.makedirs(self.dark_map_folder)

	# creare cartella per immagini binary AND salient maps
        self.binary_and_salient_maps_image_folder = "/home/student/catkin_ws/results/6_binary_and_salient_maps_images"
        if not os.path.exists(self.binary_and_salient_maps_image_folder):
            os.makedirs(self.binary_and_salient_maps_image_folder)

        self.bright_and_salient_map_folder = "/home/student/catkin_ws/results/6_binary_and_salient_maps_images/bright_maps"
        if not os.path.exists(self.bright_and_salient_map_folder):
            os.makedirs(self.bright_and_salient_map_folder)

        self.dark_and_salient_map_folder = "/home/student/catkin_ws/results/6_binary_and_salient_maps_images/dark_maps"
        if not os.path.exists(self.dark_and_salient_map_folder):
            os.makedirs(self.dark_and_salient_map_folder)

        # creare cartella per immagini classification
        self.classification_image_folder = "/home/student/catkin_ws/results/7_classification_images"
        if not os.path.exists(self.classification_image_folder):
            os.makedirs(self.classification_image_folder)

        # creare cartella per report testuali delle classificazioni
        self.classification_text_folder = "/home/student/catkin_ws/results/8_classification_texts"
        if not os.path.exists(self.classification_text_folder):
            os.makedirs(self.classification_text_folder)
